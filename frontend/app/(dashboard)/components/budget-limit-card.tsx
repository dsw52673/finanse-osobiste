...
import { ShieldAlert, PiggyBank, Pencil } from 'lucide-react'
import { setOverallBudgetAction } from '@/app/actions/budgets'
import type { BudgetOverallStatus } from '@/lib/api/types'
...
export default function BudgetLimitCard({ overallBudget }: BudgetLimitCardProps) {
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-sm bg-[#161D30] border border-[#202E4C]/50 rounded-2xl p-6 shadow-2xl z-10">
                        <h4 className="text-base font-bold text-white mb-4">
                            {limit === null ? 'Ustaw limit miesięczny' : 'Zmień limit miesięczny'}
                        </h4>
